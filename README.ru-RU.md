...
У узла нет строгого минимума по аппаратной части — принять участие может
любая машина, способная компилировать и запускать Go. В таблице ниже —
проверенные эталонные конфигурации:
